...
export function EducationForm(){
    ...
    return (
        <>
            <Input label="degree" text="Degree" value={education.degree} handler={handleInputChange} type="text"/>
            <Input label="college" text="College" value={education.college} handler={handleInputChange} type="text"/>
